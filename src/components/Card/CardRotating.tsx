          ...
          return (
            ...
            >
              <div className="relative -mt-18">
                ...
                <canvas ref={canvasRef} className={`w-full absolute inset-0 z-20 pointer-events-none`}/>
                <h2 className={`absolute -top-8 z-40 text-md text-center text-white w-[95%] mx-1 pb-1 whitespace-nowrap bg-gradient-to-r from-gray-700 via-gray-500 to-gray-700 [clip-path:polygon(2%_0%,98%_0%,100%_15%,100%_85%,98%_100%,2%_100%,0%_80%,0%_20%)]`}>{name}</h2>
              </div>
            </button>
          );
        })}
